...
//Set relative Path with CI Constant
        $this->setPath_img_upload_folder("assets/articles/");
        $this->setPath_img_thumb_upload_folder("assets/articles/thumbnails/");
...
//Set url img with Base_url()
        $this->setPath_url_img_upload_folder(base_url() . "assets/articles/");
        $this->setPath_url_img_thumb_upload_folder(base_url() . "assets/articles/thumbnails/");
		
  }

    public function index() {
      $this->load->view('upload_v/admin_view');
   }
